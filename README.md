...
+ Initial state have four input fields and one button.
+ Checking all validation of the input fields using regular expression of javaScript.
+ Dynamically Password generator and copy option added.


## Project Picture

![Regular Expression!](/src/images/regular_expression.PNG "Regular Expression")
